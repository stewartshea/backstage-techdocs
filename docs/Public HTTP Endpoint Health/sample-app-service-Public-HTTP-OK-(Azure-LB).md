---
title: "sample-app-service Public HTTP OK (Azure LB)  "
tags: 
...
!!! note ""
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock1">```curl -o /dev/null -w '{"http_code": %{http_code}, "time_total": %{time_total}}' -s https://sampleapp.example.com```</code></pre>
    </div>
    <div class="grid-item">
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/smp-t-g-http-ok-tls-aks/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'sample-app-service Public HTTP OK (Azure LB)  ';
