---
title: "argo-cd-argocd-server Nginx Ingress HTTP Errors  "
tags: 
...
# argo-cd-argocd-server Nginx Ingress HTTP Errors    
...
!!! note ""
    ...
    #### Fetch Nginx HTTP Errors From GMP for Ingress `argo-cd-argocd-server`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Find Owner and Service Health for Ingress `argo-cd-argocd-server`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/aca-arg-grnwhnnpr-ngx-ing-gmp/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'argo-cd-argocd-server Nginx Ingress HTTP Errors  ';
