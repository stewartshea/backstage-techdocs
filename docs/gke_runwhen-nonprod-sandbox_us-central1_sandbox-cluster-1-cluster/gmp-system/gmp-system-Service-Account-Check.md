---
title: "gmp-system Service Account Check  "
tags: 
...
# gmp-system Service Account Check    
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `gmp-system`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/gmp-sys-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'gmp-system Service Account Check  ';
