---
title: "ingress-nginx Service Account Check  "
tags: 
...
# ingress-nginx Service Account Check    
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `ingress-nginx`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/ing-ngn-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'ingress-nginx Service Account Check  ';
