---
title: "jon-rwl-test Service Account Check  "
tags: 
...
# jon-rwl-test Service Account Check    
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `jon-rwl-test`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/jrt-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'jon-rwl-test Service Account Check  ';
