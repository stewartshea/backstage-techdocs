---
title: "lighthouse-foghorn Deployment Health  "
tags: 
...
# lighthouse-foghorn Deployment Health    
...
!!! note ""
    ...
    #### Troubleshoot Deployment Warning Events for `lighthouse-foghorn`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Get Deployment Workload Details For `lighthouse-foghorn` and Add to Report  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock2">```kubectl get deployment/lighthouse-foghorn --context gke_runwhen-nonprod-sandbox_us-central1_sandbox-cluster-1-cluster -n jx -o yaml```</code></pre>
    </div>
    <div class="grid-item">
...
!!! note ""
    <div class="command-title">
    #### Troubleshoot Deployment Replicas for `lighthouse-foghorn`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
!!! note ""
    <div class="command-title">
    #### Check Deployment Event Anomalies for `lighthouse-foghorn`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/lf-jx-grnwhnnpr-depl-health/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'lighthouse-foghorn Deployment Health  ';
