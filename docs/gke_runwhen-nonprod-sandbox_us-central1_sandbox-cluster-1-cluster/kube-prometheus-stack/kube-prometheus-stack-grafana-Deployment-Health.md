---
title: "kube-prometheus-stack-grafana Deployment Health  "
tags: 
...
# kube-prometheus-stack-grafana Deployment Health    
...
!!! note ""
    ...
    #### Troubleshoot Deployment Warning Events for `kube-prometheus-stack-grafana`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Get Deployment Workload Details For `kube-prometheus-stack-grafana` and Add to Report  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock2">```kubectl get deployment/kube-prometheus-stack-grafana --context gke_runwhen-nonprod-sandbox_us-central1_sandbox-cluster-1-cluster -n kube-prometheus-stack -o yaml```</code></pre>
    </div>
    <div class="grid-item">
...
!!! note ""
    <div class="command-title">
    #### Troubleshoot Deployment Replicas for `kube-prometheus-stack-grafana`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
!!! note ""
    <div class="command-title">
    #### Check Deployment Event Anomalies for `kube-prometheus-stack-grafana`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/kprmth-kp-grnwh-depl-health1/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'kube-prometheus-stack-grafana Deployment Health  ';
