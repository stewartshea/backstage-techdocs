---
title: "prometheus-kube-prometheus-stack-prometheus StatefulSet Health  "
tags: 
...
# prometheus-kube-prometheus-stack-prometheus StatefulSet Health    
...
!!! note ""
    ...
    #### Fetch StatefulSet `prometheus-kube-prometheus-stack-prometheus` Logs  
    </div>
    !!! warning ""
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock1">```kubectl logs --tail=100 statefulset/prometheus-kube-prometheus-stack-prometheus --context gke_runwhen-nonprod-sandbox_us-central1_sandbox-cluster-1-cluster -n kube-prometheus-stack```</code></pre>
    </div>
    <div class="grid-item">
...
!!! note ""
    <div class="command-title">
    #### Get Related StatefulSet `prometheus-kube-prometheus-stack-prometheus` Events  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock2">```kubectl get events --field-selector type=Warning --context gke_runwhen-nonprod-sandbox_us-central1_sandbox-cluster-1-cluster -n kube-prometheus-stack | grep -i "prometheus-kube-prometheus-stack-prometheus" || true```</code></pre>
    </div>
    <div class="grid-item">
...
!!! note ""
    <div class="command-title">
    #### Fetch StatefulSet `prometheus-kube-prometheus-stack-prometheus` Manifest Details  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/prmthkprmth-kps-grnwhnnpr-ss-health/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'prometheus-kube-prometheus-stack-prometheus StatefulSet Health  ';
