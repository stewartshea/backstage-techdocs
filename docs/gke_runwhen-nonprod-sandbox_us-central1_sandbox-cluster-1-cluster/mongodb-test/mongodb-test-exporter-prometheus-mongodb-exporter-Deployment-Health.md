---
title: "mongodb-test-exporter-prometheus-mongodb-exporter Deployment Health  "
tags: 
...
# mongodb-test-exporter-prometheus-mongodb-exporter Deployment Health    
...
!!! note ""
    ...
    #### Troubleshoot Deployment Warning Events for `mongodb-test-exporter-prometheus-mongodb-exporter`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Get Deployment Workload Details For `mongodb-test-exporter-prometheus-mongodb-exporter` and Add to Report  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
    ...
    <div class="code-block-container">
      <pre class="code-block"><code id="codeBlock2">```kubectl get deployment/mongodb-test-exporter-prometheus-mongodb-exporter --context gke_runwhen-nonprod-sandbox_us-central1_sandbox-cluster-1-cluster -n mongodb-test -o yaml```</code></pre>
    </div>
    <div class="grid-item">
...
!!! note ""
    <div class="command-title">
    #### Troubleshoot Deployment Replicas for `mongodb-test-exporter-prometheus-mongodb-exporter`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
!!! note ""
    <div class="command-title">
    #### Check Deployment Event Anomalies for `mongodb-test-exporter-prometheus-mongodb-exporter`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/mngdts-mt-grnwh-depl-health2/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'mongodb-test-exporter-prometheus-mongodb-exporter Deployment Health  ';
