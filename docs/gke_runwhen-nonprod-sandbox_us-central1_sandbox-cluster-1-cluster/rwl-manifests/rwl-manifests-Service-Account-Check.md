---
title: "rwl-manifests Service Account Check  "
tags: 
...
# rwl-manifests Service Account Check    
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `rwl-manifests`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/rwl-mnf-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'rwl-manifests Service Account Check  ';
