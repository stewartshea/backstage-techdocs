---
title: "pets Nginx Ingress HTTP Errors  "
tags: 
...
# pets Nginx Ingress HTTP Errors    
...
!!! note ""
    ...
    #### Fetch Nginx HTTP Errors From GMP for Ingress `pets`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Find Owner and Service Health for Ingress `pets`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/pts-tt-grnwhnnpr-ngx-ing-gmp/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'pets Nginx Ingress HTTP Errors  ';
