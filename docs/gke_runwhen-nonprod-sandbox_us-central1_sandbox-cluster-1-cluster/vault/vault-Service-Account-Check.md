---
title: "vault Service Account Check  "
tags: 
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `vault`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/vault-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'vault Service Account Check  ';
