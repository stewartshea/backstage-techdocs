---
title: "vault-ingress Nginx Ingress HTTP Errors  "
tags: 
...
# vault-ingress Nginx Ingress HTTP Errors    
...
!!! note ""
    ...
    #### Fetch Nginx HTTP Errors From GMP for Ingress `vault-ingress`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Find Owner and Service Health for Ingress `vault-ingress`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/vi-vlt-grnwhnnpr-ngx-ing-gmp/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'vault-ingress Nginx Ingress HTTP Errors  ';
