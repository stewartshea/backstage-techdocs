---
title: "result Nginx Ingress HTTP Errors  "
tags: 
...
# result Nginx Ingress HTTP Errors    
...
!!! note ""
    ...
    #### Fetch Nginx HTTP Errors From GMP for Ingress `result`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Find Owner and Service Health for Ingress `result`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/rsl-va-grnwhnnpr-ngx-ing-gmp/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'result Nginx Ingress HTTP Errors  ';
