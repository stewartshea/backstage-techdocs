---
title: "vote Nginx Ingress HTTP Errors  "
tags: 
...
# vote Nginx Ingress HTTP Errors    
...
!!! note ""
    ...
    #### Fetch Nginx HTTP Errors From GMP for Ingress `vote`  
    </div>
    !!! warning ""
...
!!! note ""
    <div class="command-title">
    #### Find Owner and Service Health for Ingress `vote`  
    </div>
    !!! warning ""
    <div class="command-details">
    What does it do?
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/vt-va-grnwhnnpr-ngx-ing-gmp/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'vote Nginx Ingress HTTP Errors  ';
