---
title: "voting-app Service Account Check  "
tags: 
...
# voting-app Service Account Check    
...
!!! note ""
    ...
    #### Test Service Account Access to Kubernetes API Server in Namespace `voting-app`  
    </div>
    !!! warning ""
...
document.getElementById('configLink').addEventListener('click', function() {
    showConfig('/workspaces/ws/slxs/vtn-app-grnwhnnprsndbucntrl-sa-check/runbook.yaml');
});
...
function showConfig(runbook) {
    ...
    fetch('/get-runbook-config', {
        ...
        .then(data => {
            ...
            title.innerText = "Private configuration for: " + 'voting-app Service Account Check  ';
